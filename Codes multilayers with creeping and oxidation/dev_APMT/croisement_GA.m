function popnew=croisement_GA(i,i1,i2,pop,popnew,p_croisement,p_mutation,borne)
[~,size_vec]=size(pop(1,:));
chromosome_p1='';
chromosome_p2='';
...
for k=1:1:size_vec
    ...
    if abs(vec_sortie1(k))>100; vec_sortie1(k)=0;end
    if abs(vec_sortie2(k))>100; vec_sortie2(k)=0;end
